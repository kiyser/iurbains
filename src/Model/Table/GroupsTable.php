...
class GroupsTable extends Table
{
    ...
    public function initialize(array $config)
    {
        ...
        $this->setDisplayField('group_name_fr');
    ...
    public function validationDefault(Validator $validator)
    {
        ...
        $validator
            ->scalar('group_name_fr')
            ->maxLength('group_name_fr', 100)
            ->requirePresence('group_name_fr', 'create')
            ->notEmptyString('group_name_fr');

        $validator
            ->scalar('group_name_en')
            ->maxLength('group_name_en', 100)
            ->allowEmptyString('group_name_en');

        $validator
            ->scalar('group_abrev')
            ->maxLength('group_abrev', 2)
            ->allowEmptyString('group_abrev');

        $validator
            ->integer('group_state')
            ->allowEmptyString('group_state');

<section class="content-header">
	<h1><?= __('CONFIGURATION') ?><small><?= __('Ajouter un domaine') ?></small></h1>
</section>
						...
						<div class="row">
							...
							<div class="col-xs-6">
								<div class="form-group">
									...
									<?= $this->Form->control('theme_id', ['label' => false, 'required' => true, 'class' => 'form-control select2', 'options' => $themes, 'empty' => '-- Sélectionner un thème --']) ?>
								</div>
								<div class="form-group">

...
<ul class="sidebar-menu" data-widget="tree">
	...
	<li class="treeview">
		...
		<ul class="treeview-menu">
			<li>
				<a href="<?= $this->Url->build(['controller' => 'Regions', 'action' => 'index']) ?>"><i class="fa fa-circle-o"></i><?= __(' Régions') ?><span class="pull-right-container"></span></a>
			</li>
			<li>
				<a href="<?= $this->Url->build(['controller' => 'Departments', 'action' => 'index']) ?>"><i class="fa fa-circle-o"></i><?= __(' Département') ?><span class="pull-right-container"></span></a>
			</li>
			<li>
				<a href="<?= $this->Url->build(['controller' => 'Towns', 'action' => 'index']) ?>"><i class="fa fa-circle-o"></i><?= __(' Communes') ?><span class="pull-right-container"></span></a>
			</li>
		</ul>
	</li>
	<li class="treeview">
	...
	<li><a href="<?= $this->Url->build(['controller' => 'Inspectors', 'action' => 'index']) ?>"><i class="fa fa-tv"></i><?= __(' Gestion des logs') ?></a></li>
	<?php } ?>

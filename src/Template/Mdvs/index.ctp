		...
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<div class="box-body">
					...
					<?php echo $this->Form->hidden('url3', ['label' => false,'id'=>'url3', 'value'=>$this->Url->build(['controller' => 'Mdvs', 'action' => 'mdvs']), 'hidden' => true]); ?>
					<?php if($stType == 'CE' || $stType == null){ ?>
					<div class="col-xs-2">
						<label><?= __('Région') ?></label>
						<?php echo $this->Form->control('region_id', ['label'=>false, 'id'=>'region', 'onChange'=>'selectDepartment();searchMd()', 'class'=>'form-control input-sm', 'options' => $regions, 'default' => $default[0], 'empty'=>' -- Sélectionner la région -- ']);	?>
					</div>
					<?php } ?>
					<?php if($stType == 'CE' || $stType == 'RE' || $stType == null){ ?>
					<div class="col-xs-2">
						<label><?= __('Département') ?></label>
						<?php  echo $this->Form->control('department_id', ['label'=>false, 'id'=>'department', 'onChange'=>'selectTown();searchMd()', 'class'=>'form-control input-sm', 'options' => $departments, 'default' => $default[1], 'empty'=>' -- Sélectionner le département -- ']);	?>
					</div>
					<?php } ?>
					<?php if($stType == 'CE' || $stType == 'RE' || $stType == 'DE' || $stType == null){ ?>
					<div class="col-xs-2">
						<label><?= __('Commune') ?></label>
						<?php echo $this->Form->control('town_id', ['label'=>false, 'id'=>'town', 'onChange'=>'searchMd()', 'class'=>'form-control input-sm', 'options' => $towns, 'default' => $default[2], 'empty'=>' -- Sélectionner la commune -- ']);	?>
					</div>
					<?php } ?>
					<div class="col-xs-2">
						<label><?= __('Thème') ?></label>
						<?= $this->Form->control('theme_id', ['label'=>false, 'class'=>'form-control input-sm', 'id'=>'theme', 'onChange'=>'selectDomain2();startGettingMdvs();', 'options' => $themes, 'default' => $default[3], 'empty'=>' -- Sélectionner le statut -- ']); ?>
					</div>
					<div class="col-xs-2">
						<label><?= __('Domaine') ?></label>
						<?= $this->Form->control('domain_id', ['label'=>false, 'class'=>'form-control input-sm', 'id'=>'domain', 'onChange'=>'startGettingMdvs()', 'options' => $domains, 'default' => $default[4], 'empty'=>' -- Sélectionner le statut -- ']); ?>
					</div>
					<div class="col-xs-2" style="">
						<label><?= __('Année') ?></label>
						<?= $this->Form->control('version_year', ['label'=>false, 'class'=>'form-control input-sm', 'id'=>'year', 'onChange'=>'startGettingMdvs()', 'options' => $versions, 'default' => $default[5]]); ?>
					</div>
					<?= $this->Form->end() ?>
				</div>
			</div>

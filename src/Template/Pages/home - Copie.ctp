				...
				<div class="box">
					<div class="box-header with-border">
						...
						<div class="box-tools pull-right">
							<div class="btn-group">
								...
								<i class="fa fa-wrench"></i> Filtre</button>
					...
					<div class="box-body">
						<div class="row">
							<div class="col-md-12">
								<p class="text-center">
									<strong>Sales: 1 Jan, 2014 - 30 Jul, 2014</strong>								</p>
								<div class="chart">
									<canvas id="salesChart" style="height: 195px; width: 816px;" height="225" width="1020"></canvas>
								</div>
							</div>
						</div>
					</div>

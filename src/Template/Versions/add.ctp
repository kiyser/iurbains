<?= $this->Html->css('others/bootstrap-datepicker.min.css') ?>
<section class="content-header">
	<h1><?= __('GESTION DES VERSIONS') ?><small><?= __('Ajouter une version') ?></small></h1>
</section>
...
<?php echo $this->Html->script('others/bootstrap-datepicker.min'); ?>

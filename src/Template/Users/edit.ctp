<section class="content-header">
	<h1><?= __('GESTION DES UTILISATEURS') ?><small><?= __('Modifier un utilisateur') ?></small></h1>
</section>
	...
	<div class="row">
		<div class="col-xs-12">
			<div class="box box-primary">
				...
				<?= $this->Form->hidden('confirm_password', ['label' => false, 'value'=>null, 'hidden' => true]) ?>
					<div class="box-body">
						<div class="row">
							...
							<div class="col-xs-6">
								...
								<div class="form-group">
									...
									<?= $this->Form->control('group_id', ['label' => false, 'required' => true, 'class' => 'form-control select2', 'id' => 'group', 'options' => $groups, 'empty' => true, 'empty' => 'Sélectionner le groupe']) ?>
								</div>
								<div class="form-group">
									<label><?= __('Structure de l\'utilisateur') ?></label>
									<?= $this->Form->control('structure_id', ['label' => false, 'class' => 'form-control select2', 'id' => 'structure', 'options' => $structures, 'empty' => true, 'empty' => 'Sélectionner la structure']) ?>
								</div>					
								<div class="form-group">
								...
								<div class="form-group">
									...
									<?= $this->Form->control('email', ['label' => false, 'required' => true, 'class' => 'form-control', 'disabled'=>true, 'type' => 'email', 'placeholder' => 'Email de l\'utilisateur']) ?>
								</div>
								<div class="form-group">
									<label><?= __('Identifiant de connexion') ?></label><i style="color:red;">*</i>
									<?= $this->Form->control('username', ['label' => false, 'required' => true, 'class' => 'form-control', 'disabled'=>true, 'type' => 'text', 'placeholder' => 'Identifiant de connexion']) ?>
								</div>
							</div>
...
<script language="javascript">
	userGroup = "<?php echo $ui->group->group_abrev; ?>";
	if(userGroup != 'AD') {
		$("#group, #structure").attr('disabled', true);
	}
